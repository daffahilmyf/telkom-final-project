...
WebUI.callTestCase(findTestCase('Verify Element/Profil page/Photo Uploaded/Verify Element Photo Uploaded'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Profil page/Photo Uploaded/button_Ubah Gambar'))

CustomKeywords.'tools.uploadFiles.uploadFile'(findTestObject('Profil page/Card Profil Page/div_Upload Foto Profile'), 'D:\\GAMBAR\\file upload\\5500_6_05.jpg')
